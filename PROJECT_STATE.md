...
Final gates: 134 tests passing across the workspace (including 82 unit tests and 5 kittest tests in `petunia_ui`, and 42 tests in `petunia_core`); cargo fmt, strict Clippy (`-D warnings`), Prumo doctor e build estático do VitePress 100% verdes.
