...
Final gates: 129 tests passing across the workspace (including 78 unit tests and 5 kittest tests in `petunia_ui`); cargo fmt, strict Clippy (`-D warnings`), Prumo doctor e smoke test headless 100% verdes.
