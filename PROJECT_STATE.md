...
Final gates: 119 tests passing across the workspace (including 70 in `petunia_ui` and 5 kittest tests); cargo fmt, strict Clippy (`-D warnings`), Prumo doctor e smoke test headless 100% verdes.
