...
Final gates: 116 tests passing across the workspace (including 67 in `petunia_ui` and 5 kittest tests); cargo fmt, strict Clippy (`-D warnings`), Prumo doctor e smoke test headless 100% verdes.
