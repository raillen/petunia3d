...
- `ProjectService`: Serviço puro de aplicação para ciclo de vida de projeto, salvamento/carregamento (.petunia), integração com o pipeline de entrega e exportação/importação modular (OBJ, GLB, PKG, paletas) e imagens de referência.
