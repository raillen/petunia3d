...
- **Modos Suportados**: Modo de Edição (`EditMode::Edit`) e vistas ortográficas (`Numpad 1, 3, 7`).

## Aplicações
- Desenhar silhuetas a partir de imagens de referência ("blueprints");
- Geração de peças de revolução (taças, garrafas, colunas) ou extrusão ao longo de caminhos.
